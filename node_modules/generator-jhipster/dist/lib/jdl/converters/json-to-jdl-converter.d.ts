...
import type { JHipsterYoRcContent, JSONEntity } from '../core/types/json-config.js';
 ...
 */
export declare function convertToJDL(directory?: string, output?: string | false, definition?: JDLApplicationConfig): JDLObject | undefined;
...
export declare function getJDLObjectFromSingleApplication(yoRcFileContent: JHipsterYoRcContent, entities?: Map<string, JSONEntity>, existingJDLObject?: JDLObject, runtime?: JDLRuntime): JDLObject;

 ...
 */
export declare const getTableNameFromEntityNameFallback: (entityName: string) => string | undefined;
/**
 * @deprecated TODO v9 drop this function and always write entityTableName if exists.
 */
export declare const shouldWriteEntityTableName: (entityName: string, entityTableName: string) => boolean;
